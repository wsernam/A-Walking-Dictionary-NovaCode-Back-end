...
1. `tarjeta.motivo_rechazo TEXT` (columna nueva) — CA-2.1.3
2. Índice único `etiqueta_contexto (tarjeta_id, tipo)` — CA-2.2.1 / CA-2.2.2
3. Tabla nueva `notificacion` — CA-2.1.3
