...
//
// Por ahora solo se exponen los 3 endpoints de HE-01 (Tareas Técnicas de HU-1.1/1.2/1.3):
//   POST /api/v1/decks
//   POST /api/v1/decks/:id/cards
//   POST /api/v1/cards/check-duplicate
//
// El resto de controladores/rutas de las otras 12 entidades (usuario, curso, inscripcion,
